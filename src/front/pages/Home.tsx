...
export const Home: React.FC = () => {
    ...
    if (loading && !companion) {
        return (
            <div className="home-loading">
                ...
                <p style={{ color: '#000' }}>Loading your companion...</p>
            </div>
        );
    }
    ...
    return (
        <div className="home-container">
            ...
            {/* Chat Modal Overlay */}
            <div className={`chat-overlay ${showChat ? 'active' : ''}`} onClick={handleCloseChat}>
                <div className="chat-modal" onClick={(e) => e.stopPropagation()}>
                    <div style={{
                        ...
                        <h3 style={{ margin: 0, color: '#000' }}>Chat with {companion?.name}</h3>
                        <button
